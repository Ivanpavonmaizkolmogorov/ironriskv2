...
void DrawDashboard()
  {
   ...
   LB("IR_TITLE", 20, 12, "IRONRISK DASHBOARD  v41", 16, clrWhite);
   color sc = clrGray;
     ...
     for(int i=0; i<g_RiskVarCount; i++)
      {
       ...
       ObjectSetInteger(0, cName, OBJPROP_XDISTANCE, rvX + cardW_r - (g_RiskVars[i].key=="max_drawdown" ? 52 : 28));
