...
input string   InpWebhookPath = "/api/live/";       // API Base Path
...
void DrawDashboard()
  {
   ...
   LB("IR_TITLE", 20, 12, "IRONRISK DASHBOARD v63", 16, clrWhite);
...
void DrawBootstrapScreen()
  {
   ...
   LB("IR_BOOT_T1", 80, 100, "IRONRISK DASHBOARD v63", 20, clrWhite);
      ...
      if(cid > 0)
        {
         ...
         MessageBox("Step 1 COMPLETE:\r\n"+
                    "The EA has created the isolated environment '"+g_PnlSymbol+"'.\r\n\r\n"+
                    "Step 2 (FINAL):\r\n"+
                    "Now drag the IronRisk EA from the Navigator window to the new black chart to see the Dashboard.", 
