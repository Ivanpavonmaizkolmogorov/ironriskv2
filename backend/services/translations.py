...
TRANSLATIONS = {
    "es": {
        ...
        "alert_body_ea_disconnect": "El workspace <b>{workspace}</b> lleva <b>{minutes} minutos</b> sin enviar telemetría.\n\nRevisa tu VPS de MetaTrader 5 o tu conexión a Internet para evitar operar a ciegas.",
    ...
    "en": {
        ...
        "alert_body_ea_disconnect": "Workspace <b>{workspace}</b> has not sent telemetry for <b>{minutes} minutes</b>.\n\nPlease check your MetaTrader 5 VPS or internet connection to avoid unmonitored trading.",
