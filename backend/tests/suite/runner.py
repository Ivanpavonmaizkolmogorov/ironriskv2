...
def run_all() -> dict:
    ...
    from . import test_csv_import, test_bayes, test_bayes_live, test_selection_consistency, test_risk_gauges, test_email_service, test_ci_pipeline, test_disconnect_alerts
    ...
    groups_map = {
        ...
        "disconnect_alerts": test_disconnect_alerts.run_group,
    }
